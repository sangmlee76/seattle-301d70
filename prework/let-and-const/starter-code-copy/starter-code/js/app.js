...
function displayPics(){
  ...
  // ANS: line 38 (which threw the error) contains the variable 'rando' which is block scoped once changed to 'let'; threfore, it becomes undefined when referred to it outside of the code block (in this case inside the outer while statement)
